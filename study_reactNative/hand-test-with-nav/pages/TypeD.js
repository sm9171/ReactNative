...
import ImageD from '../assets/hand-type-d.png';

const TypeD = props => {
    return (
        <View>
            <Image source={ ImageD } style={{ width: 272, height: 350 }}/>
            <Text>D. 손바닥이 위로 오고 손가락 사이를 오므린 사람</Text>
            <Text>상처받기를 두려워하는 당신은 낮선 사람에게는 차갑게 대하나 내 사람이라고 생각되면 엄청 잘해줍니다.
...
친구가 부탁하면 잘 들어주는 편으로 사기를 당하기 쉬우니 조심해야합니다.</Text>
