...
import ImageC from '../assets/hand-type-c.png';

const TypeC = props => {
    return (
        <View>
            <Image source={ ImageC } style={{ width: 272, height: 350 }}/>
            <Text>C. 손바닥이 위로 오고 손가락 사이를 벌린 사람</Text>
            <Text>당신은 무시당하는걸 싫어하며 누군가에게 호감이 있어도 잘 표현하지 않는 편입니다.
...
기분대로 행동하려는 것만 조심하면 굉장히 사랑받을 타입 입니다.</Text>
